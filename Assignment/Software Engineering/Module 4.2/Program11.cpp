...
public:
    ...
    float cal_area(int length, int breadth)//Function of calculate area of rectangle 
	{
        return length*breadth;
    }

    float cal_area(float base, float height)//Function to calculate area of triangle
	{
...
int main() {
    ...
    if (choice==1){
        ...
        cin>>radius;
        Area=a1.cal_area(radius);//calling function to calculate area of circle
        ...
        cin>>breadth;
        Area=a1.cal_area(length, breadth);//calling function to calculate area of rectangle
        ...
        cin>>height;
        Area=a1.cal_area(base, height);//calling function to calculate area of triangle
